...
namespace AD.Plugins.File
{
	public abstract class FileStore
		: AD.IFileStore, AD.IFileStoreAsync
	{
		private readonly string TAG = "AD.FileStore";

		#region IFileStore Members

		public abstract Stream OpenReadFromAssets (string path);
		...
		public bool TryMove(string from, string to, bool deleteExistingTo)
		{
			...
			{
				var logger = AD.Resolver.Resolve<ILogger> ();
				logger.Exception(TAG, exception, "Error during file move {0} : {1} : {2}", from, to, exception.ToLongString());
