...
namespace AD.Plugins.Contacts.Droid
{
  ...
  {
    internal static IEnumerable<Contact> GetContacts(bool rawContacts, ContentResolver content, Android.Content.Res.Resources resources)
    {
    ...
    internal static IEnumerable<Contact> GetContacts(ICursor cursor, bool rawContacts, ContentResolver content, Android.Content.Res.Resources resources, int batchSize)
    {
      if (cursor == null)
        yield break;
    ...
    internal static IEnumerable<Contact> GetContacts(bool rawContacts, ContentResolver content, Android.Content.Res.Resources resources, string[] ids)
    {
      ICursor c = null;
    ...
    internal static Contact GetContact(bool rawContact, ContentResolver content, Android.Content.Res.Resources resources, ICursor cursor)
    {
    ...
    internal static void FillContactExtras(bool rawContact, ContentResolver content, Android.Content.Res.Resources resources, string recordId, Contact contact)
    {
      ICursor c = null;
    ...
    private static void FillContactWithRow(Android.Content.Res.Resources resources, Contact contact, ICursor c)
    {
    ...
    internal static Note GetNote(ICursor c, Android.Content.Res.Resources resources)
    {
      return new Note { Contents = GetString(c, ContactsContract.DataColumns.Data1) };
    }

    internal static Relationship GetRelationship(ICursor c, Android.Content.Res.Resources resources)
    {
    ...
    internal static InstantMessagingAccount GetImAccount(ICursor c, Android.Content.Res.Resources resources)
    {
    ...
    internal static Address GetAddress(ICursor c, Android.Content.Res.Resources resources)
    {
    ...
    internal static Phone GetPhone(ICursor c, Android.Content.Res.Resources resources)
    {
      Phone p = new Phone();
    ...
    internal static Email GetEmail(ICursor c, Android.Content.Res.Resources resources)
    {
      Email e = new Email();
    ...
    internal static Organization GetOrganization(ICursor c, Android.Content.Res.Resources resources)
    {
    ...
    internal static Website GetWebsite(ICursor c, Android.Content.Res.Resources resources)
    {
