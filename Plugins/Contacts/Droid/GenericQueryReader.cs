...
namespace AD.Plugins.Contacts.Droid
{
  internal class GenericQueryReader<T>
    : IEnumerable<T>
  {
    public GenericQueryReader(ContentQueryTranslator translator, ContentResolver content, Android.Content.Res.Resources resources, Func<ICursor, Android.Content.Res.Resources, T> selector, string defaultSort)
    ...
    public GenericQueryReader(ContentQueryTranslator translator, ContentResolver content, Android.Content.Res.Resources resources, Func<ICursor, Android.Content.Res.Resources, T> selector)
    {
      if (translator == null)
    ...
    private readonly Func<ICursor, Android.Content.Res.Resources, T> selector;
