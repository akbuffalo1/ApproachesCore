...
namespace AD.Plugins.Contacts.Droid
{
  internal abstract class ContentQueryProvider
    : IQueryProvider
  {
    internal ContentQueryProvider(ContentResolver content, Android.Content.Res.Resources resources, ITableFinder tableFinder)
    {
    ...
    protected readonly Android.Content.Res.Resources resources;
