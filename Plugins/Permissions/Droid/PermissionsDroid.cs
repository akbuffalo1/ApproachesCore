...
namespace AD.Plugins.Permissions.Droid
{
    /// <summary>
    /// Implementation for Feature
    /// </summary>
    public class PermissionsDroid : IPermissions
    {
        ...
        public Task<PermissionStatus> CheckPermissionStatusAsync(Permission permission)
        {
            ...
            Context context = Resolver.Resolve<ICurrentActivity>().Activity ?? Application.Context;
            if (context == null)
            {
