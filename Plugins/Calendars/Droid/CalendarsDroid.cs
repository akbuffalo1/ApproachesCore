...
using AD.Plugins.Calendars;
using Calendar = AD.Plugins.Calendars.Calendar;

namespace AD.Plugins.Calendars.Droid
{
    /// <summary>
    /// Implementation for Calendars
    /// </summary>
    public class CalendarsDroid : ICalendars
    {
#region Constants
...
#region Constructor
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarsDroid"/> class.
        /// </summary>
        public CalendarsDroid()
        {
...
#region ICalendars implementation
        ...
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public Task<IEnumerable<Calendar>> GetCalendars()
        {
            return Task.Run<IEnumerable<Calendar>>(() =>
                {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public Task<Calendar> GetCalendar(string externalId)
        {
            long calendarId = -1;
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public async Task<IEnumerable<CalendarEvent>> GetEvents(Calendar calendar, DateTime start, DateTime end)
        {
            var deviceCalendar = await GetCalendar(calendar.ExternalID).ConfigureAwait(false);
...
//                CalendarContract.Events.InterfaceConsts.Id,
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public Task<CalendarEvent> GetEvent(string externalId)
        {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public async Task AddOrUpdateCalendar(Calendar calendar)
        {
            ...
            {
                var existingCalendar = await GetCalendar(calendar.ExternalID).ConfigureAwait(false);
        ...
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public async Task AddOrUpdateEvent(Calendar calendar, CalendarEvent calendarEvent)
        {
        ...
        /// <exception cref="System.InvalidOperationException">Editing recurring events is not supported</exception>
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public async Task<bool> AddEventReminder(CalendarEvent calendarEvent, CalendarEventReminder reminder)
        {
            ...
            var existingAppt = await GetEvent(calendarEvent.ExternalID).ConfigureAwait(false);
        ...
        {
            var existing = await GetCalendar(calendar.ExternalID).ConfigureAwait(false);
        ...
        /// <exception cref="System.InvalidOperationException">Editing recurring events is not supported</exception>
        /// <exception cref="PlatformException">Unexpected platform-specific error</exception>
        public async Task<bool> DeleteEvent(Calendar calendar, CalendarEvent calendarEvent)
        {
            long existingId = -1;
            ...
            //
            var existingCal = await GetCalendar(calendar.ExternalID).ConfigureAwait(false);
